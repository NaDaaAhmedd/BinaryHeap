...
public class UnitTest {
    ...
    public void testRootNull() {
        IHeap<String> heap = (IHeap) eg.edu.alexu.csd.filestructure.sort.TestRunner.getImplementationInstanceForInterface(IHeap.class);
        INode root = null;
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to getRoot of heap", var5);
        }
    ...
    public void testGetRoot() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to getRoot of heap", var4);
        }
    ...
    public void testGetRootMulti() {
        IHeap<Integer> heap = (IHeap) eg.edu.alexu.csd.filestructure.sort.TestRunner.getImplementationInstanceForInterface(IHeap.class);
        INode root = null;
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to getRoot of heap", var7);
        }
    ...
    public void testHeapSize() {
        IHeap heap = (IHeap) eg.edu.alexu.csd.filestructure.sort.TestRunner.getImplementationInstanceForInterface(IHeap.class);

        try {
            Assert.assertEquals(0L, (long)heap.size());
        } catch (Throwable var3) {
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to get Heap size", var3);
        }
    ...
    public void testHeapSizeWithInsertionAndExtraction() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to get heap size", var7);
        }
    ...
    public void testGetChildrenAndParentPointers() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to get child/parent pointer", var3);
        }
    ...
    public void testHeapifyWithNullParameter() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle null in heapify method", var4);
        }
    ...
    public void testInsertWithNullParameter() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle null in insert method", var4);
        }
    ...
    public void testInsertNormal() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to insert to heap", var3);
        }
    ...
    public void testExtractNormal() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to extract element from heap", var7);
        }
    ...
    public void testExtractEmptyHeap() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle extracting from empty heap", var4);
        }
    ...
    public void testExtractLgN() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle inserting or extracting from empty heap", var3);
        }
    ...
    public void testExtractAfterInsertingAndExtractingAllElements() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle extracting after inserting and removing all elements", var4);
        }
    ...
    public void testBuildHeapWithNull() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle build with null paramter", var4);
        }
    ...
    public void testBuildHeapWithEmptyArray() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to handle build with empty array", var3);
        }
    ...
    public void testBuildIsN() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to build heap", var4);
        }
    ...
    public void testRandomBuild() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to build heap", var7);
        }
    ...
    public void testHeapSortWithNullParameter() {
        eg.edu.alexu.csd.filestructure.sort.ISort sort = (eg.edu.alexu.csd.filestructure.sort.ISort) eg.edu.alexu.csd.filestructure.sort.TestRunner.getImplementationInstanceForInterface(eg.edu.alexu.csd.filestructure.sort.ISort.class);
        try {
            IHeap<Integer> heap = sort.heapSort((ArrayList)null);
            Assert.assertEquals(0L, (long)heap.size());
        } catch (RuntimeErrorException var3) {
        } catch (Throwable var4) {
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in heap sort", var4);
        }
    ...
    public void testHeapSortWithEmptyArray() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in heap sort", var3);
        }
    ...
    public void testNormalHeapSortSmallInput() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in heap sort", var8);
        }
    ...
    public void testSlowSortWithNullParameter() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to slow sort", var4);
        }
    ...
    public void testSlowSortWithEmptyArray() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to slow sort", var3);
        }
    ...
    public void testSlowSortWithSmallInput() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in slow sort", var6);
        }
    ...
    public void testFastSortWithNullParameter() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail to fast sort", var4);
        }
    ...
    public void testFastSortWithSmallInput() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in fast sort", var6);
        }
    ...
    public void testFastSortWithReverseInput() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in fast sort", var5);
        }
    ...
    public void testStressHeap() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in heap", var8);
        }
    ...
    public void testStressHeapWithCustomComparable() {
        IHeap<UnitTest.Pair> heap = (IHeap) eg.edu.alexu.csd.filestructure.sort.TestRunner.getImplementationInstanceForInterface(IHeap.class);
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in heap", var11);
        }
    ...
    public void testStressSlowSortWithCustomComparable() {
        eg.edu.alexu.csd.filestructure.sort.ISort<Pair> sort = (eg.edu.alexu.csd.filestructure.sort.ISort) eg.edu.alexu.csd.filestructure.sort.TestRunner.getImplementationInstanceForInterface(eg.edu.alexu.csd.filestructure.sort.ISort.class);
        String[] randomWords = new String[]{"bells", "remain", "crabby", "comfortable", "stamp", "quickest", "sulky", "worm", "vigorous", "grandfather", "crook", "show", "second", "water", "ask", "finger", "scent", "encourage", "harsh", "kaput", "spotted", "room", "harmony", "bear", "desk", "dramatic", "leg", "elite", "drop", "overjoyed", "suspend", "selection", "tow", "pancake", "doubt", "laugh", "coast", "slow", "narrow", "language", "hand", "preach", "shaky", "flavor", "spark", "uptight", "pail", "jog", "unadvised", "fortunate", "exultant", "clumsy", "rot", "train", "curtain", "spurious", "middle", "dare", "wheel", "snake", "jail", "crooked", "smoggy", "elfin", "abnormal", "skip", "skate", "basket", "amount", "invention", "vegetable", "unequaled", "part", "erratic", "branch", "car", "glib", "fish", "order", "deranged", "bomb", "overrated", "orange", "enjoy", "judicious", "finger", "cheap", "meek", "gruesome", "defective", "wicked", "bashful", "rotten", "ground", "delicious", "cellar", "chalk", "dress", "north", "serious"};
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in slow sort", var7);
        }
    ...
    public void testStressFastSortWithCustomComparable() {
        ...
        try {
            ...
            eg.edu.alexu.csd.filestructure.sort.TestRunner.fail("Fail in fast sort", var7);
        }
