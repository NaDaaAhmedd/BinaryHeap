...
public class IntegrationTest {
    ...
    public void testCreationHeap() {
        List<Class<?>> candidateClasses = eg.edu.alexu.csd.filestructure.sort.ReflectionHelper.findClassesImplementing(this.heapInterfaceToTest, this.heapInterfaceToTest.getPackage());
    ...
    public void testCreationSort() {
        List<Class<?>> candidateClasses = eg.edu.alexu.csd.filestructure.sort.ReflectionHelper.findClassesImplementing(this.sortInterfaceToTest, this.sortInterfaceToTest.getPackage());
